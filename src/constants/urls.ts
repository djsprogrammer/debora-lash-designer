...
export const GET_SERVICES = `${SERVER_URL}/all-services`
export const GET_SCHEDULINGS = `${SERVER_URL}/all-schedulings`
export const GET_EXPENSES = `${SERVER_URL}/all-expenses`
